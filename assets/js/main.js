...
qp.ui.SideNavDrawer.prototype.decorateInternal = function(a) {
    ...
    for (var b = 0; b < a.length; b++)
        goog.events.listen(a[b], goog.events.EventType.CLICK, this.handleDismissClick_, !1, this)
};
...
qp.search.GoogleCustomSearch.prototype.fetchSearchResults = function(a) {
    if ("undefined" === typeof a || null === a || "" == a)
        if (null !== this.defaultSearch_ && "" !== this.defaultSearch)
            a = this.defaultSearch_;
        else
            return;
    this.clearResults_();
...
qp.ui.SearchInput.prototype.decorateInternal = function(a) {
    ...
    goog.events.listen(this.closeButton_, goog.events.EventType.CLICK, this.handleClose_,
    !1, this)
};
